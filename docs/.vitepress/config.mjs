...
export default defineConfig({
  ...
  head: [
    [
      ...
      {
        rel: 'icon',
        href: 'https://raw.gitmirror.com/mop233/git/main/docs/public/logo.svg'
      }
    ]
  ],
  cleanUrls: true,
  ...
  themeConfig: {
    ...
    logo: 'https://raw.gitmirror.com/mop233/git/main/docs/public/logo.svg',
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/mop233/git' }]
  }
})
